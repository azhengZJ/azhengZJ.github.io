...
[官方文档](https://azhengzj.github.io/zuji-jpa/)
...
使用之前需要对`Spring Data JPA`框架有一定的了解和使用，如果还未使用过，请先写个简单的DEMO熟悉一下，具体可参考[Spring Data JPA](https://spring.io/projects/spring-data-jpa)官方文档。
